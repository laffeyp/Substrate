...
| Shared best-of-N + correction contract: `Draft`, `Candidate`, `Verdict`, `Solved`, `Exhausted` (+ `ModelUsage`) | RECORDS: `substrate/topologies/coding_flow/__init__.py` (canonical until coding_flow's #43 migration) | **3-CONSUMER shared contract** (Wave-0 #15) — coding_flow, the swebench_solver Repairer, and code_evolution consume ONE set; reused, not re-rolled (review #57 / KIT_DIARY finding 12). Sprint 133. |
