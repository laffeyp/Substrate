# NORTH STAR — substrate as the cockpit (2026-08-10, v2)

*Third version of this doc. The prior two (`NORTH-STAR-2026-08-09.md` and
`NORTH-STAR-2026-08-10.md`) stay on disk as the audit trail. This one is shorter and
cleaner: every claim is a positive one, and the vocabulary is scrubbed. The five
themes are unchanged; only the writing register moves.*
...
composable, and legible. It is the load-bearing piece — the reason substrate is a
machine, not a wrapper.
...
fluent text interface is the direct surface, not a friendlier wrapper.
